...
export const REMOVE_ALL_TRANSFERS_FROM_STORE = 'VHomes/transfer/REMOVE_ALL_TRANSFERS_FROM_STORE';
export const REMOVE_TRANSFER_FROM_STORE = 'VHomes/transfer/REMOVE_TRANSFER_FROM_STORE';

/* Actions */
const setListingTransferRequests = (listingsToTransfer) => ({ type: SET_LISTING_TRANSFER_REQUESTS, listingsToTransfer });
const removeAllTransfersFromStore = () => ({ type: REMOVE_ALL_TRANSFERS_FROM_STORE });
const removeTransferFromStore = (listingId) => ({ type: REMOVE_TRANSFER_FROM_STORE, listingId });
...
export const acceptListingTransfer = (acceptAll, listingId) => async dispatch => {
    const transferInfo = { acceptAll, listingId }
    const acceptTransferRes = await handleReq("/listings/acceptListingTransfer", "PUT", undefined, transferInfo);
