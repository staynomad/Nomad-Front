...
class ListingMap extends Component {
  ...
  onMapChange(e) {
    ...
    if (
      this.state.center.lat !== e.center.lat ||
      this.state.center.lng !== e.center.lng
    ) {
      this.setState(
        {
          center: {
...
const mapStateToProps = (state) => {
  ...
  if (state.Listing.mapListings)
    stateToReturn["mapListings"] = state.Listing.mapListings;
