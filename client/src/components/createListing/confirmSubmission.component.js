...
export default class ConfirmSubmission extends Component {
    ...
    componentDidMount() {
        let temp = ''
        temp = this.state.location.street + '\n' + this.state.location.state + ', ' + ' ' + this.state.location.zipcode + 'apt num' + this.state.location.aptnum
        this.setState({
    ...
    render () {
        return (
            <div>
                ...
                <div>
                    <h2>your address</h2>
                    <p>{this.state.completeAddress}</p>
                    ...
                    <p>{this.state.dates.start_date}</p>
