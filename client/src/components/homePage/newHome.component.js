              ...
              <div className="col-sm-12 col-md-8 col-lg-5">
                ...
                <div className=" wow fadeInUp" data-wow-delay="0.5s">
                  <div className="login_bar">
                    ...
                    <span className="subscribe_button" onclick="">
                      Search
                    </span>
                  </div>
                  <div className="intro_text">
                ...
                <div className="col-sm-12 col-md-12 col-lg-4 ">
                  <div className="home-card">
                    ...
                    <div className=" wow fadeInUp" data-wow-delay="0.5s">
                      ...
                      <p>
                        We are committed to finding you the best deal. Find
                        roommates, split the price, and never spend more than
                        $60 per night.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-sm-12 col-md-12 col-lg-4 ">
                  <div className="home-card">
                    ...
                    <div className=" wow fadeInUp" data-wow-delay="0.5s">
                      ...
                      <p>
                        Every property is ideal for both working and relaxing.
                        Our spaces have high-speed WiFi, artisan coffee, and
                        everyday amenities.{" "}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="box">
                    ...
                    <div className="test-component">
                      ...
                      <article className="test-content">
                        <p className="quote">
                          This home is great. The host was very responsive,
                          place was nice and clean. Will definitely use again
                          for sure.
                        </p>
                      </article>
                    </div>
